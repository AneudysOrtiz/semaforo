...
<body>
  <h3 class="text-center">Respetame <?php echo $calle; ?></h3>
    ...
    <div  class="row">
      <div   id="amarillo"class="col col-sm-6 col-sm-offset-3 label-warning luz">
      </div>
      </div>

    <div  class="row">
      <div  id="verde"  class="col col-sm-6 col-sm-offset-3 label-success luz">
    ...
    <br />
      ...
      <a href="config.php" class="btn btn-primary">Configurar el tiempo</a>
